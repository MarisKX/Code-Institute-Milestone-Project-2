...
function showCarDetailsRl(){
  ...
  let milageLimit = $(".cars-r-l.random-car-sale").find(".milage-limit").text();
  let discount = $(".cars-r-l.random-car-sale").find(".discount").text();
  ...
  $("#make-rent").text(make);
  $("#model-rent").text(model);
  $("#year-rent").text(year);
  $("#fuel-rent").text(fuel);
  $("#engine-rent").text(engine);
  $("#gearbox-rent").text(gearbox);
  $("#milage-limit").text(milageLimit);
  $("#discount").text(discount);
  $("#color-rent").text(color);
  $("#price-rent").text(price);
  show.classList.toggle("show");
  hide.classList.toggle("hide");
  window.scrollTo(0,0);
}

function showCarDetailsRm(){
  let show = document.querySelector(".car-list-item-rent");
  let hide = document.querySelector(".main-content-section");
  let imgSrcFirst = $(".cars-r-m.random-car-sale").find(".first-image-small").attr("src");
  let imgSrcSecond = $(".cars-r-m.random-car-sale").find(".second-image-small").attr("src");
  let imgSrcThird = $(".cars-r-m.random-car-sale").find(".third-image-small").attr("src");
  let imgSrcFourth = $(".cars-r-m.random-car-sale").find(".fourth-image-small").attr("src");
  let make = $(".cars-r-m.random-car-sale").find(".make").text();
  let model = $(".cars-r-m.random-car-sale").find(".model").text();
  let year = $(".cars-r-m.random-car-sale").find(".year").text();
  let fuel = $(".cars-r-m.random-car-sale").find(".fuel").text();
  let engine = $(".cars-r-m.random-car-sale").find(".engine").text();
  let gearbox = $(".cars-r-m.random-car-sale").find(".gearbox").text();
  let milageLimit = $(".cars-r-m.random-car-sale").find(".milage-limit").text();
  let discount = $(".cars-r-m.random-car-sale").find(".discount").text();
  let color = $(".cars-r-m.random-car-sale").find(".color").text();
  let price = $(".cars-r-m.random-car-sale").find(".price").text();
  $("#first-image-details-rent").attr("src", imgSrcFirst);
  $("#second-image-details-rent").attr("src", imgSrcSecond);
  $("#third-image-details-rent").attr("src", imgSrcThird);
  $("#fourth-image-details-rent").attr("src", imgSrcFourth);
...
function showCarDetailsRr(){
  let show = document.querySelector(".car-list-item-rent");
  let hide = document.querySelector(".main-content-section");
  let imgSrcFirst = $(".cars-r-r.random-car-sale").find(".first-image-small").attr("src");
  let imgSrcSecond = $(".cars-r-r.random-car-sale").find(".second-image-small").attr("src");
  let imgSrcThird = $(".cars-r-r.random-car-sale").find(".third-image-small").attr("src");
  let imgSrcFourth = $(".cars-r-r.random-car-sale").find(".fourth-image-small").attr("src");
  let make = $(".cars-r-r.random-car-sale").find(".make").text();
  let model = $(".cars-r-r.random-car-sale").find(".model").text();
  let year = $(".cars-r-r.random-car-sale").find(".year").text();
  let fuel = $(".cars-r-r.random-car-sale").find(".fuel").text();
  let engine = $(".cars-r-r.random-car-sale").find(".engine").text();
  let gearbox = $(".cars-r-r.random-car-sale").find(".gearbox").text();
  let milageLimit = $(".cars-r-r.random-car-sale").find(".milage-limit").text();
  let discount = $(".cars-r-r.random-car-sale").find(".discount").text();
  let color = $(".cars-r-r.random-car-sale").find(".color").text();
  let price = $(".cars-r-r.random-car-sale").find(".price").text();
  $("#first-image-details-rent").attr("src", imgSrcFirst);
  $("#second-image-details-rent").attr("src", imgSrcSecond);
  $("#third-image-details-rent").attr("src", imgSrcThird);
  $("#fourth-image-details-rent").attr("src", imgSrcFourth);
